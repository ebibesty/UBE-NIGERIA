...
function list_alias() {
	global $inc, $alias, $nb_alias, $exp4, $exp5, $alias_link, $nb_alias, $alias_name, $alias_add, $alias_delete, $confirm;
	$inc = 1;
	if ($nb_alias != 0) {
		...
		while($inc <= $nb_alias) {
			...
			echo "<div class='alias'>";
			echo "<div class='alias_name'><img src='images_easyphp/alias.gif' width='16' height='11' alt='alias' /><a href='../$alias_name/' target='_blank'>$alias_name</a></div>";
			echo "<div class='alias_path'><img src='images_easyphp/alias_path.gif' width='16' height='11' alt='alias path' border='0' />$alias_link\</div>";
			if (isset($_GET['num_alias'])) {
				if (($_GET['to'] == "del_confirm") & ($_GET['num_alias'] == $inc)) {
					echo "<div class='alias_del_confirm_frame'>";
					echo "<div class='alias_del_confirm'><a href='index.php?to=del_alias&amp;num_alias=$inc'>$confirm</a></div>";
					echo "<div class='alias_del_cancel'><a href='index.php'>cancel</a></div>";
					echo "</div>";
				} else {
					echo "<div class='alias_del'><a href='index.php?to=del_confirm&amp;num_alias=$inc'><img src='images_easyphp/del.gif' width='12' height='9' alt='alias path' border='0' />$alias_delete</a></div>";
				}
			} else {
				echo "<div class='alias_del'><a href='index.php?to=del_confirm&amp;num_alias=$inc'><img src='images_easyphp/del.gif' width='12' height='9' alt='alias path' border='0' />$alias_delete</a></div>";
			}
